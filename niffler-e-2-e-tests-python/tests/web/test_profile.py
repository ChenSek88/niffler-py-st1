...
def test_add_new_category(login_app_user, is_category_in_db, remove_all_categories, logout):
...
@allure.story("Profile")
def test_update_profile_settings(login_app_user, app_user, profile_data, is_firstname_surname_in_db, logout):
    username, _ = app_user
